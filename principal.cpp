...
{
    //POdemos calcular el valor de los productos
...
{
    //Podemos verificar que la cedula sea ecuatoriana y valida
    QString temp[10];
    int aux;
    int sumaPar = 0;
    int sumaImpar = 0;
    if(temp[10].isEmpty())
    {
        QMessageBox::warning(this,"Cedula","Sin valores");
...
{
    //Limpiamos para una nueva compra
    ui->inCedula->setText("");
    ui->inNombre->setText("");;
...
{
    //Al aplastar finalizar nos enviara a la factura o mensajes de que esta incompleto el llenado
    ...
    else if(cedula == "9999999999")
    {
        ...
        compra->setCliente(clien->mostrar());
        compra->setCompra(informacion);
    ...
    {
        QMessageBox::warning(this,"Tienda","La cedula esta incorrecta");
        return;
    }
}
