...
private slots:
    //Creacion de slots para el funcionamiento del programa
...
private:
    ...
    QList<Producto*> m_productos;
     ...
     //Variables para calcular el valor de compra
    float m_subtotal;
    float m_iva;
    float m_total;
    // Metodos que nos sirven para validar los datos utilizados
